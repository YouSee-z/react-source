...
class Header extends React.Component {
    ...
    render() {
        return ( <
            div style = {
                { margin: '10px', padding: '10px', border: `10px solid ${this.context.color}` }
            } >
            Header <
            Title > < /Title> < /
            div >
    ...
    render() {
        return ( <
            ColorTheme.Consumer > {
                (value) => ( <
                    div style = {
                        { margin: '10px', padding: '10px', border: `10px solid ${value.color}` }
                    } >
                    Title
...
class Page extends React.Component {
    ...
    render() {
        ...
        return ( <
            ...
            <
            div style = {
                { margin: '10px', padding: '10px', border: `10px solid ${this.state.color}`, width: '300px' }
            } >
            Page <
            Header > < /Header> <
            Main > < /Main> < /
